(function (e) {
  ...
  "063c": function (e, t, n) {
    ...
    const o = "/api/content",
      i = {
        ...
        listComments: (e, t, n = "tree_view", i) =>
          Object(r["a"])({
            url: `${o}/${e}/${t}/comments/${n}`,
            params: i,
            method: "get",
          }),
      };
        ...
        function r(e, r, o) {
          ...
          (l.whiteSpace = "pre-wrap"),
            ...
            n
              ...
              : (l.overflow = "hidden"),
            (s.textContent = e.value.substring(0, r)),
            "INPUT" === e.nodeName &&
    ...
    e.exports = function (e, t) {
      ...
      if (((u = g ? r : b ? r[h] || s(h, {}) : (r[h] || {}).prototype), u))
        for (m in t) {
          if (
            ((p = t[m]),
            e.noTargetGet ? ((f = o(u, m)), (d = f && f.value)) : (d = u[m]),
            (n = c(g ? m : h + (b ? "." : "#") + m, e.forced)),
            !n && void 0 !== d)
          ) {
            if (typeof p === typeof d) continue;
            l(p, d);
          }
          (e.sham || (d && d.sham)) && i(p, "sham", !0), a(u, m, p, e);
        }
    };
  },
  "241c": function (e, t, n) {
    ...
    var r = n("8bbf"),
      ...
      s = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n("div", { staticClass: "comment-loader-container" }, [
          "default" === e.configs.loadingStyle
            ? n("div", { staticClass: "comment-loader-default" }, [
                n("span"),
                n("span"),
                n("span"),
                n("span"),
              ])
            : "circle" === e.configs.loadingStyle
            ? n("div", { staticClass: "comment-loader-circle" })
            : "balls" === e.configs.loadingStyle
            ? n("div", { staticClass: "comment-loader-balls" }, [
                n("div"),
                n("div"),
                n("div"),
              ])
      ...
      c = {
        name: "CommentLoading",
        props: { configs: { type: Object, required: !0 } },
      },
      u = c,
      m = n("2877"),
      d = Object(m["a"])(u, s, l, !1, null, null, null, !0),
      p = d.exports,
      f = function () {
        var e = this,
          t = e.$createElement,
        ...
        return n(
          ...
          [
            n(
              "li",
              { staticClass: "page-item", class: { disabled: !e.hasPrev } },
              [
                n(
                  "button",
                  {
            ...
            e._l(e.middlePages, function (t) {
              return n(
                "li",
                {
                  key: t,
                  staticClass: "page-item",
                  class: { active: t === e.page },
                },
                [
                  n(
                    "button",
            ...
            n(
              "li",
              { staticClass: "page-item", class: { disabled: !e.hasNext } },
              [
                n(
                  "button",
                  {
                    staticClass: "next-button",
                    on: { click: e.handleNextClick },
                  },
                  [e._v("下一页")]
                ),
              ]
      ...
      g = {
        ...
        props: {
          page: { type: Number, required: !1, default: 0 },
          size: { type: Number, required: !1, default: 10 },
        ...
        computed: {
          ...
          hasMorePrev() {
            return (
              !(null === this.firstPage || this.pages <= this.middleSize + 2) &&
              this.page >= 2 + this.middleSize / 2
            );
          },
          hasMoreNext() {
            return (
              !(null === this.lastPage || this.pages <= this.middleSize + 2) &&
              this.page < this.lastPage - 1 - this.middleSize / 2
            );
          },
          middlePages() {
            ...
            let t = this.page - e,
              n = this.page + e;
            return (
              this.page <= this.firstPage + e + 1
                ? ((t = this.firstPage + 1), (n = t + this.middleSize - 1))
                : this.page >= this.lastPage - e - 1 &&
                  ((n = this.lastPage - 1), (t = n - this.middleSize + 1)),
              this.range(t, n + 1)
            );
          },
          lastPage() {
  ...
  "2b80": function (e, t, n) {
     ...
     */ (function (o, i) {
      ...
      var a = "0.7.24",
            ...
            for (var n in t)
              if (typeof t[n] === m && t[n].length > 0) {
                for (var r = 0; r < t[n].length; r++)
                  if (E.has(t[n][r], e)) return n === l ? i : n;
              } else if (E.has(t[n], e)) return n === l ? i : n;
            return e;
          },
        },
        A = {
        ...
        O = {
          browser: [
            ...
            [h, [y, C.str, A.browser.oldsafari.version]],
            [/(webkit|khtml)\/([\w\.]+)/i],
            [h, y],
          ...
          device: [
            ...
            [/(sprint\s(\w+))/i],
            [
              [b, C.str, A.device.sprint.vendor],
              [f, C.str, A.device.sprint.model],
              [g, x],
            ],
            [
          ...
          os: [
            ...
            [h, [y, C.str, A.os.windows.version]],
            [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
            [
              [h, "Windows"],
              [y, C.str, A.os.windows.version],
            ],
            [/\((bb)(10);/i],
            [[h, "BlackBerry"], y],
            [
        ...
        T = function (e, t) {
          if (
            ("object" === typeof e && ((t = e), (e = i)), !(this instanceof T))
          )
          ...
          return (
            (this.getBrowser = function () {
              ...
              return (
                C.rgx.call(e, n, r.browser), (e.major = E.major(e.version)), e
              );
            }),
      ...
      (T.VERSION = a),
        (T.BROWSER = { NAME: h, MAJOR: p, VERSION: y }),
        ...
        (T.ENGINE = { NAME: h, VERSION: y }),
        (T.OS = { NAME: h, VERSION: y }),
        typeof t !== u
          ? (typeof e !== u && e.exports && (t = e.exports = T),
            (t.UAParser = T))
          : ((r = function () {
              return T;
            }.call(t, n, t, e)),
  ...
  "3f17": function (e, t, n) {
    ...
    var r,
      o = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return e.isCurrReply
          ? n(
              "section",
              {
                ref: "editor",
                staticClass: "comment-editor",
                attrs: { id: e.respondId, role: "form" },
              },
              [
                e.isReply
                  ? n(
                  ...
                  [
                    e.previewMode
                      ? n("div", {
                          ...
                          domProps: { innerHTML: e._s(e.renderedContent) },
                        })
                      : n("div", { staticClass: "comment-textarea" }, [
                          n("textarea", {
                            directives: [
                              {
                                name: "model",
                            ...
                            domProps: { value: e.comment.content },
                            on: {
                              input: function (t) {
                                t.target.composing ||
                                  e.$set(e.comment, "content", t.target.value);
                              },
                            },
                          }),
                    ...
                    n("div", { attrs: { id: "upload-img-show" } }),
                    n(
                      "p",
                      {
                        staticClass: "no-select",
                        attrs: { id: "emotion-toggle" },
                      },
                      [
                        n(
                          "span",
                          { on: { click: e.handleToogleDialogEmoji } },
                          [
                            e._v(
                              e._s(
                                e.emojiDialogVisible
                                  ? "嘿嘿嘿 ヾ(≧∇≦*)ゝ"
                                  : "戳我试试 OωO"
                              )
                            ),
                    ...
                    n(
                      ...
                      [
                        n("VEmojiPicker", {
                          ...
                          attrs: { pack: e.emojiPack },
                          on: { select: e.handleSelectEmoji },
                        }),
                      ],
                      1
                    ),
                      ...
                      [
                        ...
                        n("PopupInput", {
                          ...
                          attrs: {
                            ...
                            popupText:
                              e.configs.authorPopup ||
                              "输入QQ号将自动拉取昵称和头像",
                            inputType: "text",
                            placeholder: "* 昵称",
                            id: "author",
                          },
                          on: { blurInput: e.pullInfo },
                          model: {
                    ...
                    n("ul", { staticClass: "comment-buttons" }, [
                      e.comment.content
                        ? n(
                            "li",
                            {
                            ...
                            [
                              n(
                                "a",
                                {
                                  ...
                                  on: { click: e.handlePreviewContent },
                                },
                                [e._v(e._s(e.previewMode ? "编辑" : "预览"))]
                              ),
                            ]
                          )
                        : e._e(),
                      n("li", { staticClass: "middle" }, [
                        n(
                          "a",
                          {
        ...
        return n(
          ...
          [
            ...
            n(
              ...
              [
                n("EmojiList", {
                  attrs: { data: e.emojis, category: e.category },
                  on: {
                    select: function (t) {
      ...
      f = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n("transition", { attrs: { name: "category" } }, [
          n("table", { staticClass: "motion-switcher-table" }, [
            n("tbody", [
              n(
                "tr",
      ...
      S = function () {
        ...
        return n(
          "span",
          {
            staticClass: "emotion-secter emotion-item emotion-select-parent",
      ...
      E = j,
      C = Object(y["a"])(E, S, _, !1, null, null, null, !0),
      A = C.exports,
      O = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n("a", { staticClass: "emoji-item" }, [
          e._v(" " + e._s(e.data.name) + " "),
        ]);
      },
      T = [],
      z = { name: "MenheraEmoji", props: { data: { type: Object } } },
      P = z,
      I = Object(y["a"])(P, O, T, !1, null, null, null, !0),
      $ = I.exports,
      R = function () {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n("span", { attrs: { title: e.data.description } }, [
          n("img", { attrs: { src: e.tiebaSrc } }),
        ]);
      },
      L = [],
      N = {
        ...
        props: {
          ...
          url: {
            ...
            required: !1,
            default:
              "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/smilies/",
          },
        },
        computed: {
          tiebaSrc() {
      ...
      D = {
        name: "EmojiList",
        components: { BilibiliEmoji: A, MenheraEmoji: $, TiebaEmoji: U },
        data: () => ({
          categories: [
            { name: "bilibili", title: "bilibili~" },
            { name: "menhera", title: "(✪ω✪)" },
        ...
        props: { data: { type: Object }, category: { type: String } },
        methods: {
          onSelect(e, t) {
      ...
      G = {
        name: "VEmojiPicker",
        props: {
          pack: { type: Array, required: !0 },
          showCategory: { type: Boolean, default: !0 },
        },
        components: { Categories: v, EmojiList: F },
        data: () => ({ mapEmojis: {}, category: "bilibili" }),
        created() {
        ...
        methods: {
          ...
          mapperData(e) {
            e.forEach((e) => {
              const t = e["category"];
              this.mapEmojis[t]
                ? this.mapEmojis[t].push(e)
                : this.$set(this.mapEmojis, t, [e]);
            });
          },
        },
        beforeDestroy() {
      ...
      H = G,
      V = Object(y["a"])(H, d, p, !1, null, null, null, !0),
      W = V.exports,
      Q = n("fb89"),
      X = n("f058"),
      Z = n("ca00"),
      ...
      re = {
        props: {
          popupStyle: String,
          popupText: { type: String, required: !0 },
    ...
    (ue.id = "activate-canvas"),
      (ue.width = window.innerWidth),
      (ue.height = window.innerHeight),
      (ue.style.cssText =
    ...
    function ge() {
      var e,
        t =
          null != document.activeElement.shadowRoot
      ...
      if (
        ...
        var n = ce()(t, t.selectionEnd);
        return (
          (e = t.getBoundingClientRect()),
          { x: n.left + e.left, y: n.top + e.top, color: he(t) }
        );
      }
      ...
      if (r.rangeCount) {
        var o = r.getRangeAt(0),
          i = o.startContainer;
        return (
          i.nodeType === document.TEXT_NODE && (i = i.parentNode),
    ...
    function ye() {
      var e =
        null != document.activeElement.shadowRoot
          ? document.activeElement.shadowRoot.ownerDocument
          : document;
      null == e.getElementById("activate-canvas") &&
        (e.body.appendChild(ue), (r = ue.getContext("2d")));
      var t = ge(),
        n = 5 + Math.round(10 * Math.random());
      while (n--) (me[de] = be(t.x, t.y, t.color)), (de = (de + 1) % 500);
      if (ye.shake) {
        var o = 1 + 2 * Math.random(),
          i = o * (Math.random() > 0.5 ? -1 : 1),
          a = o * (Math.random() > 0.5 ? -1 : 1);
        (e.body.style.marginLeft = i + "px"),
          (e.body.style.marginTop = a + "px"),
          setTimeout(function () {
            (e.body.style.marginLeft = ""), (e.body.style.marginTop = "");
          }, 75);
      }
      pe || requestAnimationFrame(we);
    }
    function we() {
      (pe = !0), r.clearRect(0, 0, ue.width, ue.height);
      for (
        var e = !1, t = ue.getBoundingClientRect(), n = 0;
        n < me.length;
        ++n
      ) {
        var o = me[n];
        o.alpha <= 0.1 ||
          ...
          (r.fillStyle = o.color),
          r.fillRect(
            Math.round(o.x - 1.5) - t.left,
            Math.round(o.y - 1.5) - t.top,
            3,
            3
          ),
          (e = !0));
      }
      e ? requestAnimationFrame(we) : (pe = !1);
    }
    (ye.shake = !0), (ye.colorful = !1);
    var ve = {
        name: "CommentEditor",
        components: { VEmojiPicker: W, PopupInput: ae },
        props: {
          targetId: { type: Number, required: !1, default: 0 },
          target: {
            type: String,
            required: !1,
            default: "posts",
          ...
          replyComment: { type: Object, required: !1, default: () => {} },
          options: { required: !1, default: [] },
          configs: { type: Object, required: !0 },
        },
        data() {
          return {
            emojiPack: Q["default"],
            ...
            warnings: [],
            successes: [],
            checkType: { back: "gravatar-check", icon: "fa fa-google" },
            globalData: se["a"],
            lockPullAvatar: !1,
        ...
        computed: {
          renderedContent() {
            let e = this.comment.content ? c()(this.comment.content) : "";
            return Object(Z["h"])(Object(X["a"])(e));
          },
          commentValid() {
            return (
              !Object(Z["b"])(this.comment.author) &&
              !Object(Z["b"])(this.comment.email) &&
              !Object(Z["b"])(this.comment.content)
            );
          },
          isReply() {
          ...
          isCurrReply() {
            let e =
              !this.replyComment ||
              this.globalData.replyId == this.replyComment.id;
            return (
              e &&
                this.isReply &&
                "journals" !== this.target &&
                this.viewJump((e) => {
                  var t = this.$root.$el.offsetTop,
                    n = e.offsetTop + t,
                    r = window.innerHeight,
                    o = e.offsetHeight;
                  window.scrollTo(document.body.scrollWidth, n - r + o + 20);
                }),
              e
            );
          },
        ...
        created() {
          var e = localStorage.getItem("comment-author"),
            ...
            r = localStorage.getItem("avatar");
          (this.comment.author = e || ""),
            (this.comment.authorUrl = t || ""),
            (this.comment.email = n || ""),
            (this.avatar = r || this.avatar),
            this.$nextTick(() => {
              (ye.colorful = !0),
                (ye.shake = !1),
                document.body.addEventListener("input", ye);
            });
        },
        methods: {
          handleSubmitClick() {
            Object(Z["b"])(this.comment.author)
              ? this.$tips("昵称不能为空", 5e3, this)
              : Object(Z["b"])(this.comment.email)
              ? this.$tips("邮箱不能为空", 5e3, this)
              : Object(Z["b"])(this.comment.content)
              ? this.$tips("评论内容不能为空", 5e3, this)
              : ((this.comment.authorUrl = this.avatar),
          ...
          handleCommentCreated(e) {
            if ("PUBLISHED" === e.status)
              try {
                this.createdNewNode(e), this.$tips("评论成功！", 5e3, this);
              } catch {
                this.$tips("评论成功，刷新即可显示最新评论！", 5e3, this);
              }
            else
              this.$tips("您的评论已经投递至博主，等待博主审核！", 5e3, this);
          },
          errorImg(e) {
            const t = e.target || e.srcElement;
            (t.src =
              "https://cdn.jsdelivr.net/gh/qinhua/halo-theme-joe2.0@master/source/img/default_avatar.jpg"),
              (t.onerror = null);
          },
          createdNewNode(e) {
            let t = this.$root.$el,
            ...
            let i,
              a = new s.a({ render: (e) => e(o, { props: r }) });
            if (0 == e.parentId)
              if (t.getElementsByClassName("commentwrap").length > 0)
                i = t.getElementsByClassName("commentwrap")[0];
              else {
                (i = document.createElement("ul")),
                  i.setAttribute("class", "commentwrap");
                let e = t.getElementsByClassName("comment-empty")[0];
                e.parentNode.replaceChild(i, e);
              }
            else {
              let e = t.getElementsByClassName(
              ...
              n.length > 0
                ? (i = n[0])
                : ((i = document.createElement("ul")),
                  i.setAttribute("class", "children"),
                  e.appendChild(i));
            }
            let l = document.createElement("div");
            i.children[0] ? i.insertBefore(l, i.children[0]) : i.appendChild(l),
              a.$mount(l);
          },
          handleFailedToCreateComment(e) {
            if (400 === e.status && (this.$tips(e.data.message), e.data)) {
              const t = e.data.data;
              Object(Z["d"])(t) &&
          ...
          handleSelectEmoji(e) {
            ...
            0 != e.length &&
              ...
              n
                ? "Math" === n
                  ? (r = "f(x)=∫(" + t.name + ")sec²xdx")
                  : "BBCode" === n && (r = ":" + t.name + ":")
                : (r = t.name),
              (this.comment.content += " " + r + " "));
          },
          handleGithubLogin() {
          ...
          cancelReply(e) {
            if (
              ...
              (this.globalData.isReplyData = !1),
              "journals" !== this.target)
            ) {
              var t = this.$el.previousSibling,
                n = t.offsetTop + this.$root.$el.offsetTop;
              window.scrollTo(document.body.scrollWidth, n);
            }
          },
          pullInfo() {
            let e = this.comment.author;
            0 != e.length && Object(Z["e"])(e)
              ? this.pullQQInfo(() => {
                  this.$tips("拉取QQ信息失败！尝试拉取Gravatar", 2e3, this),
                    this.pullGravatarInfo();
                })
              : this.lockPullAvatar
              ? (this.lockPullAvatar = !1)
              : this.pullGravatarInfo();
          },
          pullQQInfo(e) {
            let t = this;
            ee.a
              .get("https://api.lixingyong.com/api/qq", {
                params: { id: t.comment.author },
              })
              .then(function (n) {
                let r = n.data;
                r.code && 500 == r.code && e(),
                  t.$tips("拉取QQ头像成功！", 2e3, t),
          ...
          pullGravatarInfo() {
            const e = m()(this.comment.email),
              t = this.options.gravatar_source || this.configs.gravatarSource;
            this.avatar =
              t + `/${e}?s=256&d=` + this.options.comment_gravatar_default;
          },
          viewJump(e, t) {
            this.$nextTick(() => {
              var n = t || this.$el;
      ...
      return [
        ...
        function (e, r) {
          ...
          while (1) {
            ...
            if ((k.push(S), !h)) break;
            var _ = String(S[0]);
            "" === _ && (l.lastIndex = c(p, a(l.lastIndex), x));
          }
          for (var j = "", E = 0, C = 0; C < k.length; C++) {
            S = k[C];
            for (
              var A = String(S[0]),
                O = m(d(s(S.index), p.length), 0),
                T = [],
                z = 1;
              z < S.length;
              z++
            ...
            var P = S.groups;
            if (f) {
              var I = [A].concat(T, O, p);
              void 0 !== P && I.push(P);
              var $ = String(r.apply(void 0, I));
            } else $ = v(A, p, O, T, P, r);
            O >= E && ((j += p.slice(E, O) + $), (E = O + A.length));
          }
          return j + p.slice(E);
        },
      ];
  ...
  "5a74": function (e, t, n) {
    ...
    var a = n("8bbf"),
      s = n.n(a);
    const l = /-(\w)/g,
      c = (e) => e.replace(l, (e, t) => (t ? t.toUpperCase() : "")),
      u = /\B([A-Z])/g,
    ...
    function v(e, t) {
      ...
      if (1 === t.nodeType) {
        const n = { attrs: x(t), domProps: { innerHTML: t.innerHTML } };
        return (
    ...
    function k(e, t) {
      ...
      function s(e) {
        ...
        (i = o.reduce((e, t, r) => ((e[t] = s[n[r]]), e), {})),
          p(t, "beforeCreate", function () {
            const e = this.$emit;
            this.$emit = (t, ...n) => (
              this.$root.$options.customElement.dispatchEvent(h(t, n)),
              e.call(this, t, ...n)
            );
          }),
          p(t, "created", function () {
            o.forEach((e) => {
            ...
            r = new MutationObserver((e) => {
              ...
              for (let n = 0; n < e.length; n++) {
                ...
                a && "attributes" === r.type && r.target === this
                  ? l(this, r.attributeName)
                  : (t = !0);
              }
              t &&
                (n.slotChildren = Object.freeze(
                  w(n.$createElement, this.childNodes)
                ));
            });
          r.observe(this, {
            childList: !0,
          ...
          if (e._isMounted) f(this.vueComponent, "activated");
            ...
            a
              ...
              (e.slotChildren = Object.freeze(
                w(e.$createElement, this.childNodes)
              )),
              e.$mount(),
    ...
    var S = k,
        ...
        return n(
          ...
          [
            e.isReply
              ...
              : e._e(),
            e.mergedConfigs.autoLoad || e.loaded
              ? e._e()
              : n("div", { staticClass: "comment-load-button" }, [
                  n(
                    "a",
                    {
            ...
            e.comments.length >= 1
              ...
              : e._e(),
            e.loaded && !e.commentLoading && e.comments.length <= 0
              ? n("div", { staticClass: "comment-empty" }, [
                  e._v(
                    " " + e._s(e.mergedConfigs.notComment || "暂无评论") + " "
                  ),
                ])
              : e._e(),
            e.pagination.pages > 1
              ? n(
                  "div",
      ...
      C =
        (n("2af9"),
        {
          ...
          autoLoad: !0,
          showUserAgent: !0,
          gravatarSource: "https://cn.gravatar.com/avatar",
      ...
      A = n("063c"),
      O = n("9efd");
    const T = "/api/content/options",
      z = {
        list: () => Object(O["a"])({ url: T + "/comment", method: "get" }),
      };
    var P = z,
      I = n("0e4d"),
      $ =
      ...
      N = function (e) {
        return (
          null == e ||
          ("function" !== typeof e &&
            "object" !== ("undefined" === typeof e ? "undefined" : $(e)))
        );
      },
      B = function (e, t) {
      ...
      U = function (e) {
        var t = "undefined" === typeof e ? "undefined" : $(e);
        return "undefined" === t
          ? "undefined"
          : null === e
          ? "null"
          ...
          ? "undefined" !== typeof e.constructor.name &&
            ...
            ? "generatorfunction"
            : "function"
          : "undefined" !== typeof Array.isArray && Array.isArray(e)
          ? "array"
          : e instanceof RegExp
          ? "regexp"
          : e instanceof Date
    ...
    function Y(e, t) {
      for (var n in (B(e, t), t))
        if ("__proto__" !== n && G(t, n)) {
          var r = t[n];
          F(r)
            ? ("undefined" === U(e[n]) && "function" === U(r) && (e[n] = r),
              (e[n] = q(e[n] || {}, r)))
            : (e[n] = r);
        }
      return e;
    ...
    var X = { event: "event", observer: "observer" },
      Z = (function () {
        if (V)
    ...
    function ee(e, t) {
      if ("IMG" === e.tagName && e.getAttribute("data-srcset")) {
        ...
        for (var c = "", u = void 0, m = 0; m < r.length; m++) {
          (u = r[m]), (c = u[1]);
          var d = r[m + 1];
          if (d && d[0] < i) {
            c = u[1];
    ...
    var ae = ie(),
      se = {
        on: function (e, t, n) {
          ...
          ae
            ? e.addEventListener(t, n, { capture: r, passive: !0 })
      ...
      ue = function (e) {
        return ce(e, "overflow") + ce(e, "overflow-y") + ce(e, "overflow-x");
      },
      me = function (e) {
        if (V) {
          ...
          while (t) {
            ...
            if (/(scroll|auto)/.test(ue(t))) return t;
            t = t.parentNode;
          }
          return window;
        }
    ...
    var ge = (function () {
        ...
        return (
          L(e, [
            ...
            },
            {
              ...
              value: function () {
                var e = this;
                pe(this.options.filter).map(function (t) {
              ...
              value: function () {
                ...
                return this.attempt > this.options.attempt - 1 &&
                  ...
                  : void this.renderLoading(function () {
                      e.attempt++,
                        e.options.adapter["beforeLoad"] &&
                          e.options.adapter["beforeLoad"](e, e.options),
                        e.record("loadStart"),
                        le(
                          { src: e.src },
                          function (n) {
          ...
          function t(e) {
            ...
            R(this, t),
              ...
              (this.options = {
                ...
                adapter: f || {},
                observer: !!h,
                observerOptions: g || ve,
              }),
              this._initEvent(),
              (this._imageCache = new ge({ max: 200 })),
              (this.lazyLoadHandler = oe(
            ...
            L(t, [
              ...
              },
              {
                ...
                value: function (t, n, r) {
                  var o = this;
                  if (
                    K(this.ListenerQueue, function (e) {
                      return e.el === t;
                    })
                  )
                  ...
                  var i = this._valueFormatter(n.value),
                    ...
                    l = i.error;
                  e.nextTick(function () {
                    (a = ee(t, o.options.scale) || a),
                      o._observer && o._observer.observe(t);
                    var i = Object.keys(n.modifiers)[0],
                      c = void 0;
                    i &&
                      ((c = r.context.$refs[i]),
                      (c = c ? c.$el || c : document.getElementById(i))),
                      c || (c = me(t));
                    var u = new be({
                      bindType: n.arg,
                      $parent: c,
                    ...
                    o.ListenerQueue.push(u),
                      V &&
                        (o._addListenerTarget(window), o._addListenerTarget(c)),
                      o.lazyLoadHandler(),
                      e.nextTick(function () {
              ...
              },
              {
                ...
                value: function (t, n, r) {
                  var o = this,
                    ...
                    s = i.loading,
                    l = i.error;
                  a = ee(t, this.options.scale) || a;
                  var c = te(this.ListenerQueue, function (e) {
                    return e.el === t;
                  });
                  c
                    ? c.update({ src: a, loading: s, error: l })
                    : this.add(t, n, r),
                    this._observer &&
              ...
              },
              {
                ...
                value: function (e) {
                  if (e) {
                    ...
                    var t = te(this.ListenerQueue, function (t) {
                      return t.el === e;
                    });
                    t &&
                      (this._removeListenerTarget(t.$parent),
                      this._removeListenerTarget(window),
                      J(this.ListenerQueue, t),
                      t.$destroy());
                  }
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  if (e) {
                    var t = te(this.TargetQueue, function (t) {
                      return t.el === e;
                    });
                    return (
                      t
                        ...
                        : ((t = {
                          ...
                          this.mode === X.event && this._initListen(t.el, !0),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  this.options.ListenEvents.forEach(function (r) {
                    return se[t ? "on" : "off"](e, r, n.lazyLoadHandler);
                  });
                },
              },
              {
        ...
        return (
          L(e, [
            ...
            },
            {
              key: "update",
              value: function (e, t, n) {
                var r = te(this._queue, function (t) {
                  return t.el === e;
                });
          ...
          L(e, [
            {
              ...
              value: function (e) {
                var t = this,
                  n = e.el,
                  r = e.binding;
                (this.el = n), (this.options = H({}, _e, r.value));
                var o = this.getImgs();
                    ...
                    H({}, t.binding, {
                      value: {
                        ...
                        error:
                          ("dataset" in e
                            ? e.dataset.error
                            : e.getAttribute("data-error")) || t.options.error,
                        loading:
                          ("dataset" in e
                            ? e.dataset.loading
            ...
            },
            {
              key: "getImgs",
              value: function () {
                return fe(this.el.querySelectorAll(this.options.selector));
              },
            },
            {
              key: "clear",
      ...
      Ce = {
        install: function (e) {
          ...
          (e.prototype.$Lazyload = r),
            t.lazyComponent && e.component("lazy-component", ke(r)),
            t.lazyImage && e.component("lazy-image", Ee(r)),
            i
              ? (e.directive("lazy", {
                  bind: r.add.bind(r),
      ...
      Pe = ze,
      Ie = Object(_["a"])(Pe, Oe, Te, !1, null, null, null, !0),
      $e = Ie.exports;
    let Re,
      Le = s.a.extend($e),
      Ne = null,
      Be = (e, t = 6e3, n) => {
        if (!Re) {
          (Re = new Le()), (Re.vm = Re.$mount());
          var r = n.$root.$el;
          r.appendChild(Re.vm.$el);
        }
        Ne &&
          (clearTimeout(Ne), (Ne = null), (Re.show = !1), (Re.message = "")),
          (Re.time = 3e3),
          "string" === typeof e &&
            ((Re.message = e),
            "number" === typeof t && (Re.time = t),
            (Re.show = !0),
            (Ne = setTimeout(() => {
              (Re.show = !1), clearTimeout(Ne), (Ne = null), (Re.message = "");
            }, Re.time)));
      };
    Be.install = (e) => {
      e.prototype.$tips = Be;
    ...
    s.a.use(Ae, {
      error:
        "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.1/img/Sakura/images/Transparent_Akkarin.th.jpg",
      loading:
        "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/svg/loader/trans.ajax-spinner-preloader.svg",
      attempt: 1,
    }),
      s.a.use(Me);
    var De = {
        ...
        props: {
          ...
          configs: { type: Object, required: !1, default: () => C },
        },
        data() {
          return {
            comments: [],
            pagination: { pages: 0, page: 0, sort: "", size: 5, total: 0 },
            commentLoading: !1,
            loaded: !1,
            repliedSuccess: null,
            replyingComment: null,
            options: { comment_gravatar_default: "mm" },
            globalData: I["a"],
          };
        },
        computed: {
          ...
          mergedConfigs() {
            var e;
            if ("string" === typeof this.configs) e = JSON.parse(this.configs);
            else {
              if ("object" !== typeof this.configs)
                throw new TypeError("参数类型错误");
              e = this.configs;
            }
            return Object(Ue["g"])(e), Object.assign(C, e);
          },
          isReply() {
            return 0 == this.globalData.replyId;
          },
    ...
    var Fe = Object(_["a"])(qe, j, E, !1, Ye, null, null, !0),
      Ge = Fe.exports;
    window.customElements.define("halo-comment", S(s.a, Ge));
  },
  "5c6c": function (e, t) {
    e.exports = function (e, t) {
      return {
        ...
        a = function (e, n) {
          ...
          for (p = 0; p < s.length; p += 16) {
            var y = c,
              ...
              v = m,
              x = d;
            (c = f(c, u, m, d, s[p + 0], 7, -680876936)),
              (d = f(d, c, u, m, s[p + 1], 12, -389564586)),
              (m = f(m, d, c, u, s[p + 2], 17, 606105819)),
              (u = f(u, m, d, c, s[p + 3], 22, -1044525330)),
              (c = f(c, u, m, d, s[p + 4], 7, -176418897)),
              (d = f(d, c, u, m, s[p + 5], 12, 1200080426)),
              (m = f(m, d, c, u, s[p + 6], 17, -1473231341)),
              (u = f(u, m, d, c, s[p + 7], 22, -45705983)),
              (c = f(c, u, m, d, s[p + 8], 7, 1770035416)),
              (d = f(d, c, u, m, s[p + 9], 12, -1958414417)),
              (m = f(m, d, c, u, s[p + 10], 17, -42063)),
              (u = f(u, m, d, c, s[p + 11], 22, -1990404162)),
              (c = f(c, u, m, d, s[p + 12], 7, 1804603682)),
              (d = f(d, c, u, m, s[p + 13], 12, -40341101)),
              (m = f(m, d, c, u, s[p + 14], 17, -1502002290)),
              (u = f(u, m, d, c, s[p + 15], 22, 1236535329)),
              (c = h(c, u, m, d, s[p + 1], 5, -165796510)),
              (d = h(d, c, u, m, s[p + 6], 9, -1069501632)),
              (m = h(m, d, c, u, s[p + 11], 14, 643717713)),
              (u = h(u, m, d, c, s[p + 0], 20, -373897302)),
              (c = h(c, u, m, d, s[p + 5], 5, -701558691)),
              (d = h(d, c, u, m, s[p + 10], 9, 38016083)),
              (m = h(m, d, c, u, s[p + 15], 14, -660478335)),
              (u = h(u, m, d, c, s[p + 4], 20, -405537848)),
              (c = h(c, u, m, d, s[p + 9], 5, 568446438)),
              (d = h(d, c, u, m, s[p + 14], 9, -1019803690)),
              (m = h(m, d, c, u, s[p + 3], 14, -187363961)),
              (u = h(u, m, d, c, s[p + 8], 20, 1163531501)),
              (c = h(c, u, m, d, s[p + 13], 5, -1444681467)),
              (d = h(d, c, u, m, s[p + 2], 9, -51403784)),
              (m = h(m, d, c, u, s[p + 7], 14, 1735328473)),
              (u = h(u, m, d, c, s[p + 12], 20, -1926607734)),
              (c = g(c, u, m, d, s[p + 5], 4, -378558)),
              (d = g(d, c, u, m, s[p + 8], 11, -2022574463)),
              (m = g(m, d, c, u, s[p + 11], 16, 1839030562)),
              (u = g(u, m, d, c, s[p + 14], 23, -35309556)),
              (c = g(c, u, m, d, s[p + 1], 4, -1530992060)),
              (d = g(d, c, u, m, s[p + 4], 11, 1272893353)),
              (m = g(m, d, c, u, s[p + 7], 16, -155497632)),
              (u = g(u, m, d, c, s[p + 10], 23, -1094730640)),
              (c = g(c, u, m, d, s[p + 13], 4, 681279174)),
              (d = g(d, c, u, m, s[p + 0], 11, -358537222)),
              (m = g(m, d, c, u, s[p + 3], 16, -722521979)),
              (u = g(u, m, d, c, s[p + 6], 23, 76029189)),
              (c = g(c, u, m, d, s[p + 9], 4, -640364487)),
              (d = g(d, c, u, m, s[p + 12], 11, -421815835)),
              (m = g(m, d, c, u, s[p + 15], 16, 530742520)),
              (u = g(u, m, d, c, s[p + 2], 23, -995338651)),
              (c = b(c, u, m, d, s[p + 0], 6, -198630844)),
              (d = b(d, c, u, m, s[p + 7], 10, 1126891415)),
              (m = b(m, d, c, u, s[p + 14], 15, -1416354905)),
              (u = b(u, m, d, c, s[p + 5], 21, -57434055)),
              (c = b(c, u, m, d, s[p + 12], 6, 1700485571)),
              (d = b(d, c, u, m, s[p + 3], 10, -1894986606)),
              (m = b(m, d, c, u, s[p + 10], 15, -1051523)),
              (u = b(u, m, d, c, s[p + 1], 21, -2054922799)),
              (c = b(c, u, m, d, s[p + 8], 6, 1873313359)),
              (d = b(d, c, u, m, s[p + 15], 10, -30611744)),
              (m = b(m, d, c, u, s[p + 6], 15, -1560198380)),
              (u = b(u, m, d, c, s[p + 13], 21, 1309151649)),
              (c = b(c, u, m, d, s[p + 4], 6, -145523070)),
              (d = b(d, c, u, m, s[p + 11], 10, -1120210379)),
              (m = b(m, d, c, u, s[p + 2], 15, 718787259)),
              (u = b(u, m, d, c, s[p + 9], 21, -343485551)),
              (c = (c + y) >>> 0),
              (u = (u + w) >>> 0),
              (m = (m + v) >>> 0),
              (d = (d + x) >>> 0);
          }
          return t.endian([c, u, m, d]);
        };
  ...
  "69f3": function (e, t, n) {
    ...
    e.exports = { set: r, get: o, has: i, enforce: f, getterFor: h };
  },
  "6eeb": function (e, t, n) {
    var r = n("da84"),
      o = n("9112"),
    ...
    (e.exports = function (e, t, n, s) {
      ...
      "function" == typeof n &&
        ...
        (u(n).source = m.join("string" == typeof t ? t : ""))),
        e !== r
    ...
    var o = n("7f73"),
      ...
      m = function (e) {
        ...
        var n = i(t, l),
          r = e,
          s = e;
        return o(e) && ((r = c(n, e)), (s = u(n, e))), t.then(r, s);
      };
    if (Object.getOwnPropertyDescriptor) {
      var d = Object.getOwnPropertyDescriptor(m, "name");
      d &&
        d.configurable &&
    ...
    (s[h] = !0),
      (e.exports =
        ...
        function (e, t) {
          ...
          return (
            null !== e
              ? ((g[p] = o(e)), (n = new g()), (g[p] = null), (n[h] = e))
              : (n = v()),
            void 0 === t ? n : i(n, t)
          );
        });
  ...
  "7dd0": function (e, t, n) {
    ...
    e.exports = function (e, t, n, u, p, x, k) {
      o(n, t, u);
      var S,
        _,
        j,
      ...
      if (
        (P &&
          ...
          f !== Object.prototype &&
            ...
            (m ||
              i(S) === f ||
              (a ? a(S, f) : "function" != typeof S[g] && l(S, g, v)),
            s(S, C, !0, !0),
            m && (d[C] = v))),
        p == y &&
          T &&
        ...
        if (((_ = { values: E(y), keys: x ? z : E(b), entries: E(w) }), k))
          for (j in _) (h || A || !(j in O)) && c(O, j, _[j]);
        else r({ target: t, proto: !0, forced: h || A }, _);
      return _;
    };
  },
  "7f73": function (e, t, n) {
      ...
      function e() {
        ...
        try {
          ...
          for (var d = 0; d < m.length; d++) {
            if ("interactive" === m[d].readyState) return m[d];
            if (m[d].src === l) return m[d];
            if (l === u && m[d].innerHTML && m[d].innerHTML.trim() === o)
              return m[d];
          }
          return null;
        }
      ...
      (s = function (e) {
        ...
        return (
          d &&
            ((p = p.replace("y", "")),
            -1 === p.indexOf("g") && (p += "g"),
            (g = String(e).slice(m.lastIndex)),
            m.lastIndex > 0 &&
              (!m.multiline || (m.multiline && "\n" !== e[m.lastIndex - 1])) &&
              ((f = "(?: " + f + ")"), (g = " " + g), h++),
            (n = new RegExp("^(?:" + f + ")", p))),
          u && (n = new RegExp("^" + f + "$(?!\\s)", p)),
          l && (t = m.lastIndex),
          (o = i.call(d ? n : m, g)),
          d
            ? o
              ? ((o.input = o.input.slice(h)),
                (o[0] = o[0].slice(h)),
                (o.index = m.lastIndex),
                (m.lastIndex += o[0].length))
              : (m.lastIndex = 0)
            : l && o && (m.lastIndex = m.global ? o.index + o[0].length : t),
          u &&
            o &&
            o.length > 1 &&
  ...
  "9ed3": function (e, t, n) {
    ...
    e.exports = function (e, t, n) {
      var c = t + " Iterator";
      return (
        (e.prototype = o(r, { next: i(1, n) })), a(e, c, !1, !0), (s[c] = l), e
      );
    };
  },
  "9efd": function (e, t, n) {
    ...
    var r = n("bc3a"),
      o = n.n(r);
    n("09bd").shim();
    const i = o.a.create({ baseURL: "", timeout: 5e3, withCredentials: !0 });
  ...
  a571: function (e, t, n) {
    (function (t, n) {
      ...
      var a = i(function (e) {
          function t() {
            return {
              ...
              xhtml: !1,
              bilibiliEmojiUrl:
                "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.1/img/bili/",
              codeEmojiEmojiUrl:
                "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.1/img/Sakura/images/smilies/",
            };
          }
          function n(t) {
      ...
      function p(e, t) {
        if (t) {
          if (s.test(e)) return e.replace(l, d);
        } else if (c.test(e)) return e.replace(u, d);
        return e;
      }
      ...
      function B(e, t, n) {
        ...
        return "!" !== e[0].charAt(0)
          ...
          : { type: "image", raw: n, href: r, title: o, text: L(i) };
      }
      function M(e, t) {
        var n = e.match(/^(\s+)(?:```)/);
        if (null === n) return t;
          ...
          return (
            ...
            (t.code = function (e, t) {
              ...
              if (n) {
                ...
                return {
                  ...
                  text: this.options.pedantic ? o : $(o, "\n"),
                };
              }
            }),
            (t.fences = function (e) {
              ...
              if (t) {
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (o = n.cells.length, r = 0; r < o; r++)
                    n.cells[r] = R(n.cells[r], n.header.length);
                  return n;
                }
              }
            }),
              ...
              if (t) {
                for (
                  ...
                  (n = f[b]),
                    ...
                    b !== g - 1 &&
                      ((o = this.rules.block.bullet.exec(f[b + 1])[0]),
                      (m
                        ? 1 === o.length || (!d && ")" === o[o.length - 1])
                        : o.length > 1 ||
                          (this.options.smartLists && o !== u)) &&
                        ((i = f.slice(b + 1).join("\n")),
                        (p.raw = p.raw.substring(0, p.raw.length - i.length)),
                        (b = g - 1))),
                    (a = h || /\n\n(?!\s*$)/.test(n)),
                    b !== g - 1 &&
                      ((h = "\n" === n.charAt(n.length - 1)), a || (a = h)),
                    a && (p.loose = !0),
                    (s = /^\[[ xX]\] /.test(n)),
                    (l = void 0),
                    s &&
            ...
            (t.def = function (e) {
              ...
              if (t) {
                ...
                return { tag: n, raw: t[0], href: t[2], title: t[3] };
              }
            }),
            (t.table = function (e) {
            ...
            (t.escape = function (e) {
              ...
              if (t) return { type: "escape", raw: t[0], text: L(t[1]) };
            }),
            ...
            (t.autolink = function (e, t) {
              ...
              if (o)
                return (
                  "@" === o[2]
                    ? ((n = L(this.options.mangle ? t(o[1]) : o[1])),
                      (r = "mailto:" + n))
                    : ((n = L(o[1])), (r = n)),
                  {
                    type: "link",
            ...
            (t.url = function (e, t) {
              ...
              if ((n = this.rules.inline.url.exec(e))) {
                var r, o;
                if ("@" === n[2])
                  (r = L(this.options.mangle ? t(n[0]) : n[0])),
                    (o = "mailto:" + r);
                else {
                  var i;
                  do {
                  ...
                  (r = t
                    ? this.options.sanitize
                      ? this.options.sanitizer
                        ...
                        : L(o[0])
                      : o[0]
                    : L(this.options.smartypants ? n(o[0]) : o[0])),
                  { type: "text", raw: o[0], text: r }
                );
            }),
            e
          );
      ...
      (F.def = q(F.def)
        ...
        (F.bullet = /(?:[*+-]|\d{1,9}[.)])/),
        (F.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
        (F.item = q(F.item, "gm").replace(/bull/g, F.bullet).getRegex()),
        (F.list = q(F.list)
        ...
        (F.pedantic = Y({}, F.normal, {
          ...
          heading: /^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,
          fences: D,
          paragraph: q(F.normal._paragraph)
            .replace("hr", F.hr)
            .replace("heading", " *#{1,6} *[^\n]")
      ...
      (G.em = q(G.em)
        ...
        (G.link = q(G.link)
          ...
          .getRegex()),
        (G.reflink = q(G.reflink).replace("label", G._label).getRegex()),
        (G.normal = Y({}, G)),
        (G.pedantic = Y({}, G.normal, {
          strong:
      ...
      var J = (function () {
          function e(e) {
            ...
            var t = { block: W.normal, inline: Q.normal };
            this.options.pedantic
              ? ((t.block = W.pedantic), (t.inline = Q.pedantic))
              : this.options.gfm &&
                ((t.block = W.gfm),
                this.options.breaks
                  ? (t.inline = Q.breaks)
          ...
          return (
            ...
            (n.inlineTokens = function (e, t, n, r) {
              ...
              void 0 === t && (t = []),
                ...
                void 0 === r && (r = !1);
              while (e)
                if ((o = this.tokenizer.bilibiliEmoji(e)))
                  (e = e.substring(o.raw.length)), o.type && t.push(o);
                else if ((o = this.tokenizer.textEmoji(e)))
                  (e = e.substring(o.raw.length)), o.type && t.push(o);
                else if ((o = this.tokenizer.codeEmoji(e)))
                  (e = e.substring(o.raw.length)), o.type && t.push(o);
                else if ((o = this.tokenizer.escape(e)))
                  ...
                  (e = e.substring(o.raw.length)),
                    "link" === o.type &&
                      (o.tokens = this.inlineTokens(o.text, [], !0, r)),
                    t.push(o);
                else if ((o = this.tokenizer.strong(e)))
                  (e = e.substring(o.raw.length)),
                    (o.tokens = this.inlineTokens(o.text, [], n, r)),
                    t.push(o);
                else if ((o = this.tokenizer.em(e)))
                  (e = e.substring(o.raw.length)),
                    (o.tokens = this.inlineTokens(o.text, [], n, r)),
                    t.push(o);
                  ...
                  if ((o = this.tokenizer.inlineText(e, r, X)))
                    (e = e.substring(o.raw.length)), t.push(o);
                  else if (e) {
          ...
          return (
            (t.bilibiliEmoji = function (e) {
              ...
              return (
                (t = ee(
                  this.options.sanitize,
                  this.options.bilibiliEmojiUrl,
                  t
                )),
                '<span class="emotion-inline emotion-item ' +
                  e +
                  '" data-icon="' +
                  e +
                  '"><img src="' +
            ...
            (t.codeEmoji = function (e) {
              ...
              return (
                (t = ee(
                  this.options.sanitize,
                  this.options.codeEmojiEmojiUrl,
                  t
                )),
                '<img src="' +
                  t +
            ...
            (t.link = function (e, t, n) {
              if (
                ((e = ee(this.options.sanitize, this.options.baseUrl, e)),
                null === e)
              )
                return n;
              var r = '<a href="' + te(e) + '"';
          ...
          return (
              ...
              for (n = 0; n < x; n++)
                switch (((m = e[n]), m.type)) {
                  ...
                  case "code":
                    ...
                    continue;
                  case "table":
                    for (c = "", l = "", i = m.header.length, r = 0; r < i; r++)
                      l += this.renderer.tablecell(
                        this.parseInline(m.tokens.header[r]),
                        { header: !0, align: m.align[r] }
                      );
                    for (
                      ...
                      for (
                        s = m.tokens.cells[r], l = "", a = s.length, o = 0;
                        o < a;
                        o++
                      )
                  ...
                  case "list":
                    for (
                      ...
                      (g = m.items[r]),
                        ...
                        (u += this.renderer.listitem(h, y, b));
                    v += this.renderer.list(u, d, p);
                    continue;
                  case "html":
            ...
            (t.parseInline = function (e, t) {
              ...
              for (n = 0; n < i; n++)
                switch (((r = e[n]), r.type)) {
                  case "bilibiliEmoji":
                    o += t.bilibiliEmoji(r.text);
                    break;
                  case "textEmoji":
                    o += t.textEmoji(r.text);
                    break;
                  case "codeEmoji":
                    o += t.codeEmoji(r.text);
                    break;
                  case "escape":
                    o += t.text(r.text);
                    break;
            ...
            switch ((t(i), i.type)) {
              case "table":
                ...
                for (var c, u = o(i.tokens.cells); !(c = u()).done; )
                  for (var m, d = c.value, p = o(d); !(m = p()).done; ) {
                    var f = m.value;
                    fe.walkTokens(f, t);
                  }
                break;
  ...
  b189: function (e, t, n) {
    ...
    if (!Object.keys) {
      var o = Object.prototype.hasOwnProperty,
        ...
        f = function (e) {
          if ("undefined" === typeof window || !p) return m(e);
          try {
            return m(e);
          } catch (t) {
            return !1;
      ...
      r = function (e) {
        ...
        if (r && e.length > 0)
          ...
          for (var g in e)
            (d && "prototype" === g) || !o.call(e, g) || m.push(String(g));
        if (l)
          for (var b = f(e), y = 0; y < u.length; ++y)
            (b && "constructor" === u[y]) || !o.call(e, u[y]) || m.push(u[y]);
        return m;
      };
    }
    e.exports = r;
  ...
  b50d: function (e, t, n) {
    ...
    e.exports = function (e) {
      return new Promise(function (t, n) {
        var m = e.data,
          d = e.headers;
        r.isFormData(m) && delete d["Content-Type"];
  ...
  b622: function (e, t, n) {
    var r = n("da84"),
      ...
      c = o("wks"),
      u = r.Symbol,
      m = l ? u : (u && u.withoutSetter) || a;
    e.exports = function (e) {
      return (
        i(c, e) || (s && i(u, e) ? (c[e] = u[e]) : (c[e] = m("Symbol." + e))),
        c[e]
      );
    };
  },
  ...
  ca00: function (e, t, n) {
    ...
    function f(e) {
      return (e = p(e)), (e = m(e)), (e = d(e)), e.replace(/\r?\n/g, "<br />");
    }
    function h(e, t) {
  ...
  e9ac: function (e, t, n) {
    ...
    var a,
      ...
      h = l ? d(l) : r,
      g = l ? l() : r,
      b = "undefined" === typeof Uint8Array ? r : d(Uint8Array),
      y = {
        "%Array%": Array,
        "%ArrayBuffer%": "undefined" === typeof ArrayBuffer ? r : ArrayBuffer,
        "%ArrayBufferPrototype%":
          "undefined" === typeof ArrayBuffer ? r : ArrayBuffer.prototype,
        "%ArrayIteratorPrototype%": m ? d([][Symbol.iterator]()) : r,
        ...
        "%AsyncGenerator%": l ? d(g) : r,
        "%AsyncGeneratorFunction%": h,
        "%AsyncGeneratorPrototype%": h ? h.prototype : r,
        "%AsyncIteratorPrototype%":
          g && m && Symbol.asyncIterator ? g[Symbol.asyncIterator]() : r,
        ...
        "%isFinite%": isFinite,
        "%isNaN%": isNaN,
        "%IteratorPrototype%": m ? d(d([][Symbol.iterator]())) : r,
        "%JSON%": "object" === typeof JSON ? JSON : r,
        "%JSONParse%": "object" === typeof JSON ? JSON.parse : r,
        "%Map%": "undefined" === typeof Map ? r : Map,
        "%MapIteratorPrototype%":
          "undefined" !== typeof Map && m ? d(new Map()[Symbol.iterator]()) : r,
        ...
        "%SetIteratorPrototype%":
          "undefined" !== typeof Set && m ? d(new Set()[Symbol.iterator]()) : r,
        ...
        "%String%": String,
        "%StringIteratorPrototype%": m ? d(""[Symbol.iterator]()) : r,
        "%StringPrototype%": String.prototype,
        "%Symbol%": m ? Symbol : r,
        "%SymbolPrototype%": m ? Symbol.prototype : r,
      ...
      w = n("0f7c"),
      v = w.call(Function.call, String.prototype.replace),
      x =
        /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
      k = /\\(\\)?/g,
      S = function (e) {
        var t = [];
        return (
          v(e, x, function (e, n, r, o) {
            t[t.length] = r ? v(o, k, "$1") : n || e;
          }),
          t
        );
      },
    ...
    e.exports = function (e, t) {
      ...
      for (
        var n = S(e), r = _("%" + (n.length > 0 ? n[0] : "") + "%", t), o = 1;
        o < n.length;
        o += 1
      )
        if (null != r)
  ...
  f058: function (e, t, n) {
    ...
    function o(e) {
      let t = new DOMParser(),
        ...
        o = n.getElementsByClassName("emotion-item");
      for (let i = 0; i < o.length; i++) {
        let e = o[i].getAttribute("data-icon");
        for (let t = 0; t < r["default"].length; t++)
          if (r["default"][t]["name"] === e) {
            let e = r["default"][t],
              n = o[i].getElementsByClassName("img")[0],
              a = "";
    ...
    function i(e) {
      let t = e.getElementsByClassName("smilies"),
        n = !0;
      for (let i = 0; i < t.length; i++) {
        let e = t[i].dataset.icon;
        if (!s("tieba", e)) {
          n = !1;
          break;
        }
    ...
    function s(e, t) {
      return (
        r["default"].filter((n) => n.category === e && n.name === t).length > 0
      );
    }
  },
  f367: function (e, t, n) {
  ...
  f9af: function (e, t, n) {
    ...
    var r = function () {
        ...
        return n(
          ...
          [
            n(
              ...
              [
                n("div", { staticClass: "contents" }, [
                  n("div", { staticClass: "main shadow" }, [
                    n("div", { staticClass: "profile" }, [
                      n(
                        "a",
                        { attrs: { href: "javascript:;", rel: "nofollow" } },
                        [
                          n("img", {
                            directives: [
                              {
                    ...
                    n("div", { staticClass: "commentinfo" }, [
                      n("section", { staticClass: "commeta" }, [
                        n("div", { staticClass: "left" }, [
                          n("h4", { staticClass: "author" }, [
                            n(
                              "a",
                              {
                                attrs: {
                        ...
                        n("div", { staticClass: "right" }, [
                          n("div", { staticClass: "info" }, [
                            n(
                              ...
                              [e._v("发布于 " + e._s(e.createTimeAgo) + " ")]
                            ),
                            e.configs.showUserAgent
                              ? n("span", {
                                  staticClass: "useragent-info",
                                  domProps: {
                                    innerHTML: e._s(e.compileUserAgent),
                                  },
                                })
                              : e._e(),
                          ]),
                    ...
                    n("div", { staticClass: "body markdown-body" }, [
                      n("p", {
                        domProps: { innerHTML: e._s(e.compileContent) },
                      }),
                    ]),
                  ]),
                ]),
      ...
      p = {
        name: "CommentNode",
        components: { CommentEditor: m["a"] },
        props: {
          parent: { type: Object, required: !1, default: void 0 },
          depth: { type: Number, required: !1, default: 1 },
          ...
          comment: { type: Object, required: !1, default: () => {} },
        ...
        created() {
          const e = {
            image(e, t) {
              return `\n          <img src="${e}" title="${t}" class="lazyload comment_inline_img" onerror="errorImg(this)">`;
            },
            link(e, t, n) {
              return `<a href="${e}" title="${t}" target="_blank" rel="nofollow">${n}</a>`;
            },
          };
          c.a.use({ renderer: e });
        },
        computed: {
          avatar() {
            if (this.comment.authorUrl) return this.comment.authorUrl;
            {
              const e =
                this.options.gravatar_source || this.configs.gravatarSource;
              return (
                e +
          ...
          compileContent() {
            ...
            void 0 != this.parent &&
              (e =
                ...
                this.parent.author +
                " </a>");
            let t = c()(e + this.comment.content),
              n = Object(u["a"])(t);
            return Object(i["h"])(n);
          },
          createTimeAgo() {
            return Object(i["i"])(this.comment.createTime);
          },
          compileUserAgent() {
            var e = new s.a();
            ...
            switch (t.os.name) {
              ...
              default:
                r =
                  "https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/ua/svg/" +
                  t.os.name.replace(/\s+/g, "").toLowerCase() +
                  ".svg";
                break;
            }
            return (
  ...
  fb89: function (e, t, n) {
    ...
    let o = [
      ...
      i = [
        ...
        new r("(;¬_¬)", "(;¬_¬)", "menhera"),
        new r("(▔□▔)/", "(▔□▔)/", "menhera"),
        new r("(ﾟДﾟ≡ﾟдﾟ)!?", "(ﾟДﾟ≡ﾟдﾟ)!?", "menhera"),
        new r("Σ(ﾟдﾟ;)", "Σ(ﾟдﾟ;)", "menhera"),
        new r("Σ(￣□￣||)", "Σ(￣□￣||)", "menhera"),
        new r("(’；ω；‘)", "(’；ω；‘)", "menhera"),
        new r("（/TДT)/", "（/TДT)/", "menhera"),
        new r("(^・ω・^ )", "(^・ω・^ )", "menhera"),
        new r("(｡･ω･｡)", "(｡･ω･｡)", "menhera"),
        new r("(●￣(ｴ)￣●)", "(●￣(ｴ)￣●)", "menhera"),
        new r("ε=ε=(ノ≧∇≦)ノ", "ε=ε=(ノ≧∇≦)ノ", "menhera"),
        new r("(’･_･‘)", "(’･_･‘)", "menhera"),
        new r("(-_-#)", "(-_-#)", "menhera"),
        new r("（￣へ￣）", "（￣へ￣）", "menhera"),
        new r("(￣ε(#￣)Σ", "(￣ε(#￣)Σ", "menhera"),
        new r("ヽ(‘Д’)ﾉ", "ヽ(‘Д’)ﾉ", "menhera"),
        new r("（#-_-)┯━┯", "（#-_-)┯━┯", "menhera"),
        new r("(╯°口°)╯(┴—┴", "(╯°口°)╯(┴—┴", "menhera"),
        new r("←◡←", "←◡←", "menhera"),
        new r("( ♥д♥)", "( ♥д♥)", "menhera"),
        new r("_(:3」∠)_", "_(:3」∠)_", "menhera"),
        new r("Σ>―(〃°ω°〃)♡→", "Σ>―(〃°ω°〃)♡→", "menhera"),
        new r("⁄(⁄ ⁄•⁄ω⁄•⁄ ⁄)⁄", "⁄(⁄ ⁄•⁄ω⁄•⁄ ⁄)⁄", "menhera"),
        new r("(╬ﾟдﾟ)▄︻┻┳═一", "(╬ﾟдﾟ)▄︻┻┳═一", "menhera"),
        new r("･*･:≡(　ε:)", "･*･:≡(　ε:)", "menhera"),
        new r("(笑)", "(笑)", "menhera"),
        new r("(汗)", "(汗)", "menhera"),
        new r("(泣)", "(泣)", "menhera"),
      ...
      a = [
        new r("tongue", "吐舌", "tieba"),
        new r("theblackline", "尴尬", "tieba"),
        new r("tear", "大哭", "tieba"),
        new r("surprised", "惊哭", "tieba"),
        new r("surprised2", "惊讶", "tieba"),
        new r("spray", "喷", "tieba"),
        new r("spit", "呕吐", "tieba"),
        new r("smilingeyes", "笑眼", "tieba"),
        new r("shui", "睡", "tieba"),
        new r("shame", "羞辱", "tieba"),
        new r("se", "色", "tieba"),
        new r("rmb", "钱", "tieba"),
        new r("reluctantly", "勉强", "tieba"),
        new r("rbq", "观望", "tieba"),
        new r("niconiconit", "niconiconit", "tieba"),
        new r("niconiconi", "niconiconi", "tieba"),
        new r("niconiconi_t", "niconiconi-t", "tieba"),
        new r("naive", "naive", "tieba"),
        new r("ku", "ku", "tieba"),
        new r("huaji", "huaji", "tieba"),
        new r("hu", "hu", "tieba"),
        new r("han", "han", "tieba"),
        new r("haha", "haha", "tieba"),
        new r("good", "good", "tieba"),
        new r("doubt", "doubt", "tieba"),
        new r("britan", "britan", "tieba"),
        new r("bbd", "bbd", "tieba"),
        new r("awesome", "awesome", "tieba"),
        new r("anger", "anger", "tieba"),
        new r("aa", "aa", "tieba"),
        new r("Happy", "Happy", "tieba"),
        new r("Grievance", "Grievance", "tieba"),
      ];
    t["default"] = [...o, ...i, ...a];
  },
  fc6a: function (e, t, n) {
