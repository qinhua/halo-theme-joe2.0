...
<header class="joe_header${settings.enable_fixed_header?then(' active','')}${settings.enable_glass_blur?then(' glass','')}">
  ...
  <#--  web菜单  -->
  <div class="joe_header__above${settings.enable_show_in_up?then(' animated showInDown','')}">
