        ...
        <div class="joe_container joe_main_container page-post">
            <div class="joe_main joe_post">
                ...
                <div class="joe_detail" data-cid="${post.id}" data-clikes="${post.likes}" data-curl="${post.fullPath}">
                    ...
                    <article class="joe_detail__article animated fadeIn${settings.enable_code_line_number?string(' line-numbers', '')}${settings.enable_copy?string(' copyable', '')}${settings.enable_indent?string(' indent','')}">
                        ${post.formatContent!}
                    </article>
                ...
                <#if settings.enable_clean_mode!=true && settings.enable_comment>
