    ...
    <div class="joe_container joe_main_container"> 
        <div class="joe_main"> 
            <div class="joe_wallpaper__type"> 
                <div class="joe_wallpaper__type-title"><i class="joe-font joe-icon-tupian"></i>&nbsp;我的壁纸</div>
            </div>
            <div class="joe_wallpaper__list">
                <#list photos.content as photo>
                    <a class="item animated bounceIn" data-fancybox="gallery" href="${photo.url!}">
                    <img width="100%" height="100%" class="lazyload" src="${photo.thumbnail!}" data-src="${photo.thumbnail!}" alt="壁纸">
                    </a>
                </#list>
            </div>            
