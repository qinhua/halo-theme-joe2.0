...
<div class="joe_detail__operate">
    <div class="joe_detail__operate-tags">
      ...
      <#if settings.enable_share>
        <div class="joe_detail__operate-share">
            ...
            <div class="share-icon-list">
                ...
                <a href="https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=${post.fullPath!}&sharesource=qzone&title=${post.title!}&pics=${post.thumbnail!}" target="_blank" rel="noopener noreferrer" title="分享到QQ空间">
                    <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="30" height="30">
                ...
                <a href="https://connect.qq.com/widget/shareqq/index.html?url=${post.fullPath!}&title=${post.title!}&pics=${post.thumbnail!}" target="_blank" rel="noopener noreferrer" title="分享到QQ">
                    <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="30" height="30">
                ...
                <a id="share_to_weixin" href="javascript:;" title="分享到微信">
                    ...
                    <div class="qrcode_wrapper bounceIn">
      ...
      <#if settings.enable_donate!false>
        <#include "donate.ftl">
      </#if>
</div>