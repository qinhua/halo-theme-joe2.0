        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a class="item" href="${settings.banner1_url}" target="_blank" rel="noopener noreferrer nofollow">
                    <img width="100%" height="100%" class="thumbnail lazyload" src="https://cdn.jsdelivr.net/gh/qinhua/cdn_assets/img/lazyload.jpeg" data-src="${settings.banner1_img}">
           ...
           <#if settings.banner2_img?? && settings.banner2_img != '' && settings.banner2_url?? && settings.banner2_url != ''>
            <div class="swiper-slide">
                <a class="item" href="${settings.banner2_url}" target="_blank" rel="noopener noreferrer nofollow">
                    <img width="100%" height="100%" class="thumbnail lazyload" src="https://cdn.jsdelivr.net/gh/qinhua/cdn_assets/img/lazyload.jpeg" data-src="${settings.banner2_img}">
            ...
            <div class="swiper-slide">
                <a class="item" href="${settings.banner3_url}" target="_blank" rel="noopener noreferrer nofollow">
                    <img width="100%" height="100%" class="thumbnail lazyload" src="https://cdn.jsdelivr.net/gh/qinhua/cdn_assets/img/lazyload.jpeg" data-src="${settings.banner3_img}">
